...
var Pet = /** @class */function (_super) {
    ...
    Pet.prototype.render = function () {
        ...
        return react_1.default.createElement(router_1.Link, { to: "/details/" + id, className: "pet" }, react_1.default.createElement("div", { className: "image-container" }, react_1.default.createElement("img", { src: hero, alt: name })), react_1.default.createElement("div", { className: "info" }, react_1.default.createElement("h1", null, name), react_1.default.createElement("h2", null, animal, " - ", breed, " - ", location)));
    };
    return Pet;
}(react_1.Component);
exports.default = Pet;
...
var SearchContext_1 = require("./SearchContext");
if (!"a824f5a589f6cb083de0c1fecb836ac0" || !"b15bb930def2c43ef59b820bc0fa6eb6") {
...
var Results = /** @class */function (_super) {
    ...
    Results.prototype.render = function () {
        return react_1.default.createElement("div", { className: "search" }, react_1.default.createElement(SearchBox_1.default, { search: this.search }), this.state.pets.map(function (pet) {
            var breed;
            ...
            return react_1.default.createElement(Pet_1.default, { key: pet.id, name: pet.name, animal: pet.animal, breed: breed, media: pet.media, location: pet.contact.city + ", " + pet.contact.state, id: pet.id });
        }));
    };
    return Results;
}(react_1.Component);
function ResultsWithContext(props) {
    return react_1.default.createElement(SearchContext_1.Consumer, null, function (context) {
        return react_1.default.createElement(Results, __assign({}, props, { searchParams: context }));
    });
}
...
var Carousel = /** @class */function (_super) {
    ...
    function Carousel() {
        ...
        _this.handleIndexClick = function (ev) {
    ...
    Carousel.prototype.render = function () {
        ...
        var _a = this.state,
            photos = _a.photos,
            active = _a.active;
        return react_1.default.createElement("div", { className: "carousel" }, react_1.default.createElement("img", { src: photos[active].value, alt: "primary animal" }), react_1.default.createElement("div", { className: "carousel-smaller" }, photos.map(function (photo, index) {
            return (
                /*eslint-disable-next-line*/
                react_1.default.createElement("img", { key: photo.value, "data-index": index, src: photo.value, className: index === active ? "active" : "", alt: "animal thumbnail", onClick: _this.handleIndexClick })
            );
        })));
    };
    return Carousel;
...
var Details = /** @class */function (_super) {
    ...
    Details.prototype.render = function () {
        ...
        return react_1.default.createElement("div", { className: "details" }, react_1.default.createElement(Carousel_1.default, { media: media }), react_1.default.createElement("div", null, react_1.default.createElement("h1", null, name), react_1.default.createElement("h2", null, animal, " - ", breed, " - ", location), react_1.default.createElement("button", { onClick: this.toggleModal }, "Adpot ", name), react_1.default.createElement("p", null, description), showModal ? react_1.default.createElement(Modal_1.default, null, react_1.default.createElement("h1", null, "Would you like to adopt ", name), react_1.default.createElement("div", { className: "buttons" }, react_1.default.createElement("button", { onClick: this.toggleModal }, "Yes!!"), react_1.default.createElement("button", { onClick: this.toggleModal }, "Definete\xF1y Yes!!"))) : null));
    };
    return Details;
}(react_1.Component);
...
var SearchParams = /** @class */function (_super) {
    ...
    SearchParams.prototype.render = function () {
        return react_1.default.createElement("div", { className: "search-route" }, react_1.default.createElement(SearchBox_1.default, { search: this.handleSearchSubmit }));
    };
    return SearchParams;
}(react_1.Component);
exports.default = SearchParams;
},{"react":"../node_modules/react/index.js","./SearchBox":"SearchBox.tsx","@reach/router":"../node_modules/@reach/router/es/index.js"}],"App.tsx":[function(require,module,exports) {
"use strict";
...
var App = /** @class */function (_super) {
    ...
    App.prototype.render = function () {
        return react_1.default.createElement("div", null, react_1.default.createElement("header", null, react_1.default.createElement(router_1.Link, { to: "/" }, "Adopt Me!"), react_1.default.createElement(router_1.Link, { to: "/search-params" }, react_1.default.createElement("span", { "aria-label": "search", role: "img" }, "\uD83D\uDD0D"))), react_1.default.createElement(SearchContext_1.Provider, { value: this.state }, react_1.default.createElement(router_1.Router, null, react_1.default.createElement(Results_1.default, { path: "/" }), react_1.default.createElement(Details_1.default, { path: "/details/:id" }), react_1.default.createElement(SearchParams_1.default, { path: "/search-params" }))));
    };
    return App;
}(react_1.Component);
react_dom_1.render(react_1.default.createElement(App, null), document.getElementById("root"));
},{"react":"../node_modules/react/index.js","react-dom":"../node_modules/react-dom/index.js","@reach/router":"../node_modules/@reach/router/es/index.js","petfinder-client":"../node_modules/petfinder-client/index.js","./Results":"Results.tsx","./Details":"Details.tsx","./SearchParams":"SearchParams.tsx","./SearchContext":"SearchContext.ts"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/App.54d5398e.map