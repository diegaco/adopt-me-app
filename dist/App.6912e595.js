...
var App = function (_Component) {
  ...
  function App(props) {
    ...
    _this.handleAnimalChange = function (ev) {
      _this.setState({
        animal: ev.target.value,
        breed: ""
      }, _this.getBreeds); // optional method to run after setState runs.
      // this.getBreeds();
    ...
    _this.handleBreedChange = function (ev) {
      _this.setState({
...
//# sourceMappingURL=/App.6912e595.map